...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	{
		tap.authorizeRequests().antMatchers("/index**","/update**","/delete**","/save**","/addEmployee","/listEmployees**","/search**").hasAnyRole("ADMIN","MANAGER")
		...
		.and().exceptionHandling().accessDeniedPage("/WEB-INF/views/accessDeniedPage.jsp")
		.and()
		...
		.rememberMe()
		.key("myUniqueKey")		
		.rememberMeCookieN  ame("websparrow-login-remember-me")
